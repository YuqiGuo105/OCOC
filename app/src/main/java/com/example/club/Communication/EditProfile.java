        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (userType){
                    //Normal user
                    case 0:
                        Intent user = new Intent(EditProfile.this, UserAccount.class);
                        startActivity(user);
                        finish();
                        break;
                        ...
                        // Club user
                    case 1:
                        Intent club = new Intent(EditProfile.this, ClubAccount.class);
                        startActivity(club);
                        finish();
                        break;
                        ...
                        // System admin
                    case 2:
                        Intent admin = new Intent(EditProfile.this, AdminAccount.class);
                        startActivity(admin);
                        finish();
                        break;
                }
