...
import com.example.club.Communication.Noticification.register_user;
...
public class registerClub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int emailCode = Integer.parseInt(verificationCode.getText().toString().trim());
                if(emailCode == code){
                    ...
                    switch (result) {
                        ...
                        case "Club insert successfully":
                            sendOnChannel1(clubName,clubPassword,clubEmail,clubType);
                            ...
                            Toast.makeText(registerClub.this, "Register successfully!", Toast.LENGTH_SHORT).show();
    ...
    public void sendOnChannel1(String name,String password,String email,String type){
        ...
        resultIntent.putExtra("clubname",name);
        resultIntent.putExtra("clubpassword",password);
        resultIntent.putExtra("clubemail",email);
