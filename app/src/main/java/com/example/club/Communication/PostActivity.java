        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (activity.getImage() == null) {
                    Toast.makeText(PostActivity.this,"Please upload an Image",Toast.LENGTH_SHORT).show();
                } else  {
                    ManageActivityImple obj = new ManageActivityImple(PostActivity.this);
                    obj.insert(activity);

                    Intent success = new Intent(PostActivity.this, manageActivity.class);
        ...
        btnCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (userType) {
                    //Normal user
                    case 0:
                        Intent user = new Intent(PostActivity.this, UserAccount.class);
                        startActivity(user);
                        finish();
                        break;
                    ...
                    // Club user
                    case 1:
                        Intent club = new Intent(PostActivity.this, ClubAccount.class);
                        startActivity(club);
                        finish();
                        break;
                    ...
                    // System admin
                    case 2:
                        Intent admin = new Intent(PostActivity.this, AdminAccount.class);
                        startActivity(admin);
                        finish();
                        break;
                }
